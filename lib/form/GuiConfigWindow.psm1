<#
    form\GuiConfigWindow.psm1 - VENTANA del editor de config.json, clave a clave.

    Un arbol con TODAS las claves, su valor, su ayuda y si esta cambiada respecto al valor de
    partida. Los DEFAULTS son de Get-CvConfigDefaults (lib\Config.psm1) -fuente unica- y el arbol lo
    arma lib\GuiConfig.psm1. Se abre desde setup y desde la cola, por eso tiene modulo propio.
#>
